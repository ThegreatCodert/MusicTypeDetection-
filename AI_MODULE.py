"""
used Algo - KNN which works  by calculating distance and finding the K number of neighbours
...
#calculating disance between two instance 
...
#function to identify the neavrest neighbors
...
# #prediction 
# (rate,sig)=wav.read("passion-127011.wav")
